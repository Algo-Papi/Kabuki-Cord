(function (global) {
  ...
  const runtimeModeTransitionLabels = Object.freeze({
    dry: Object.freeze(["Dry Mode", "Scanning only. Sends are blocked."]),
    full_auto: Object.freeze(["Full Auto", "Eligible replies can send automatically."]),
    semi_auto: Object.freeze(["Semi Auto", "Regular replies can send; new starts need review."]),
    live_fire: Object.freeze(["Live Fire", "Every reply stays approval-gated."]),
  });
